...
export function renderStatsOverlay(customers) {
  ...
  // Guard: Only update overlay if grocery scene is active
  if (window.currentScene && window.currentScene !== 'grocery') {
    statsDiv.style.display = 'none';
    return;
  }
  if (!window.statsVisible && typeof window.statsVisible !== 'undefined') {
    statsDiv.style.display = 'none';
    return;
  } else if (typeof window.statsVisible !== 'undefined') {
